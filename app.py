...
def init_services():
    ...
    embedding_service.ensure_embeddings()  
    master_service = MasterService()
    return master_service

master_service = init_services()
...
with tab_chat:
    ...
    if user_input:
        ...
        # backend: use MasterService
        results = master_service.handle_query(user_input)
        ...
        if not results:
            ...
            for i, r in enumerate(results, 1):
                blocks.append(
f"""🔸 **Match #{i}**
🎓 **Master:** {r.get('master', 'Not available')}
